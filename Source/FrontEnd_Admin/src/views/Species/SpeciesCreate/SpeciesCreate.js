...
class SpeciesCreate extends Component {
  ...
  onHandleSubmit = (e) => {
    ...
    form_data.append('spe_cat_id', this.state.spe_cat_id);
              ...
              <Card>
                ...
                <CardBody>
                  <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
                    <FormGroup row>
                      <Col md="3">
                        <Label htmlFor="spe_category_id">Chọn chủng loại</Label>
                      </Col>
                      <Col xs="12" md="9">
                        <Input type="select" name="spe_cat_id" id="spe_cat_id"
                               onChange={this.onHandleChange}>
                          <option value={this.state.spe_cat_id}>Chọn chủng loại</option>
